...
public class ConfigDepotSingleton {
	...
	public static final ConfigDepotSingleton INSTANCE = new ConfigDepotSingleton();

	static Map<String, Map<String, String>> globalMap = new HashMap<String, Map<String, String>>();

	private ConfigDepotSingleton() {}
	
	public static ConfigDepotSingleton getInstance()
	{
		return INSTANCE;
	}
	...
	public Map<String, String> getConfig(String configFileName) {
		...
		InputStream is = ConfigDepotSingleton.class.getClassLoader().getResourceAsStream(configFileName);
	...
	public static void main(String[] args) {
		ConfigDepotSingleton configDepot = ConfigDepotSingleton.getInstance();
		...
		Map<String,	String>	prodConfig2	= configDepot.getConfig("prod.properties");
